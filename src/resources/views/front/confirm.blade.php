		...
		<form method="POST" action="{{ route('front.store') }}">
			...
			<div class="form-group row align-items-center mb-3">
				...
				<div class="col-sm-4 text-center">
					...
					<input type="hidden" name="fullname" value="{{ $validatedData['fullname'] }}" />
				</div>
			</div>
			<div class="form-group row align-items-center mb-3">
			...
			<div class="form-group row align-items-center mb-3">
				...
				<div class="col-sm-4 text-center">
					{{ $ageLabel }}
					<input type="hidden" name="age_id" value="{{ $validatedData['age_id'] }}" />
				</div>
			</div>
			...
			<div class="form-group row align-items-center mb-3">
				...
				<div class="col-sm-4 text-center">
					<div class="form-check">
						{{ $isSendEmailLabel }}
						<input type="hidden" name="is_send_email" value="{{ $validatedData['is_send_email'] }}" />
					</div>
				</div>
				...
				<div class="form-group row align-items-center mb-3">
					...
					<div class="col-sm-4 text-center">
						...
						<input type="hidden" name="feedback" value="{{ $validatedData['feedback'] }}" />
					</div>
				</div>
			</div>
